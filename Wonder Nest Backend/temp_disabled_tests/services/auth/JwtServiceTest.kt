...
class JwtServiceTest {
    ...
    inner class FlutterIntegrationTests {
        ...
        fun testUserRolesForFlutter() {
            ...
            assertEquals("CHILD", jwtService.extractRoleFromToken(childToken.accessToken))
