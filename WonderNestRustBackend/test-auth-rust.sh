...
# Tests against port 8082 (Rust) instead of 8080 (Kotlin)
...
# Extract token from response (Rust should use same format as Kotlin)
...
echo "🦀 The Rust backend is working correctly and maintains compatibility!"